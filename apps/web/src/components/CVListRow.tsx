  ...
  return (
    <div className="flex items-center gap-0.5">
      <button
        ...
        className={`flex-1 text-left py-[9px] px-3 rounded-md font-body text-[13px] cursor-pointer overflow-hidden text-ellipsis whitespace-nowrap transition-all duration-[180ms] min-w-0 border ${
          isSelected
            ...
            : "font-normal text-[#9A9AA4] border-transparent hover:bg-white/[0.025] hover:border-[#2A2A2C]"
        }`}
        style={{
      ...
      <button
        onClick={onDelete}
        disabled={disabled}
        className="py-2 px-[9px] bg-transparent border-none cursor-pointer text-[17px] leading-none shrink-0 text-[#5C5C66] hover:text-[#F87171] disabled:opacity-40 disabled:cursor-not-allowed transition-colors duration-[180ms]"
        title="Delete"
      >
        ×
      </button>
