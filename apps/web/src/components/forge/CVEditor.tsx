...
const inputClass = "w-full box-border bg-forge-base border border-forge-track rounded py-[5px] px-2 font-body text-xs text-forge-text outline-none";
  ...
  return (
    <div className="flex flex-col gap-0">
      <div className="border-b border-forge-elevated pb-3 mb-1">
        <div className="font-display text-[10px] font-bold tracking-[0.14em] uppercase text-forge-label mb-2">Header</div>
        <div className="grid grid-cols-2 gap-1.5">
          {([
            ...
            <div key={field}>
              <div className="font-body text-[10px] text-forge-label mb-[3px]">{label}</div>
              <input
                value={val as string}
          ...
          {(["email", "phone", "portfolio", "github", "location"] as const).map((f) => (
            <div key={f}>
              <div className="font-body text-[10px] text-forge-label mb-[3px] capitalize">{f}</div>
              <input
